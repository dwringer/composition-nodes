...
class ImageCompositorInvocation(BaseInvocation, WithMetadata, WithBoard):
    ...
    image_background: ImageField = InputField(default=None, description="Image of a background scene")
